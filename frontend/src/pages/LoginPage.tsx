...
const LoginPage = () => {
  return (
    <div className="bg-[#1A1D2E]  w-full min-h-screen p-[5rem]">
      <Authbackground />
      <div className="absolute top-20 flex left-[45%] items-center flex-col gap-2 justify-center z-[9999] ">
      ...
      <div className="flex absolute w-1/2 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[9999] justify-evenly mt-10 items-center">
